...
import { getSupabaseRuntimeConfigScript } from "@/lib/supabase-config";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "القائمة الرقمية | Digital Menu" },
      {
        name: "description",
        content:
          "قائمة طعام رقمية فاخرة — تصفّح أطباقنا وعروضنا بتجربة أنيقة وسريعة. A premium digital restaurant menu.",
      },
      { property: "og:title", content: "القائمة الرقمية | Digital Menu" },
      {
        property: "og:description",
        content: "قائمة طعام رقمية فاخرة — تصفّح أطباقنا وعروضنا بتجربة أنيقة وسريعة. A premium digital restaurant menu.",
      },
  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        <HeadContent />
        <script
          id="runtime-supabase-config"
          suppressHydrationWarning
          dangerouslySetInnerHTML={{ __html: getSupabaseRuntimeConfigScript() }}
        />
      </head>
      <body>
        {children}
